...
const EditEducation = () => {
    ...
    useEffect(() => {
        const getSingleQualification = async () => {
          try {
            ...
            const response = await axios.post(`https://jobpartal-backend.onrender.com/api/Qualification/${Id}`, requestBody, {
              headers: {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const res = await fetch(`https://jobpartal-backend.onrender.com/api/Update/Qualification/${Id}`, { // Corrected URL
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
